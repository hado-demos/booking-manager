...
return [
    ...
    */
    ...
    'ascii' => 'El campo :attribute debe contener caracteres alfanuméricos y símbolos de un solo byte.',
    ...
    'MaxLengthStay' => 'La duración máxima de la estancia es de :days días.',
    'ValidCPF' => 'El número de documento no es un número de CPF válido.',
    /*
    |--------------------------------------------------------------------------
    ...
    | la convención "attribute.rule" para nombrar las líneas. Esto ayuda a hacer que nuestro
    | mensaje sea más expresivo y específico.
    |
    */
    ...
    | por algo más fácil de leer, como "Dirección de correo electrónico" en lugar de "email".
