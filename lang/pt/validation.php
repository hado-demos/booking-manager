...
return [
    ...
    | classe de validação. Algumas dessas regras têm várias versões, como as regras de tamanho.
    ...
    */
    ...
    'MaxLengthStay' => 'A duração máxima da estadia é de :days dias.',
    'ValidCPF' => 'O número do documento não é um número de CPF válido.',
    /*
    |--------------------------------------------------------------------------
    ...
    | convenção "attribute.rule" para nomear as linhas. Isso ajuda a tornar nossa
    | mensagem mais expressiva e específica.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Atributos de Validação Personalizados em Português
    |--------------------------------------------------------------------------
    |
